...
if ( ! class_exists( 'El_DiviContentToggle_Update' ) ) {
	class El_DiviContentToggle_Update {
		/**
	     * Plugin Name.
	     *
	     * @since 	 1.0.3
		...
		public function __construct() {
			$this->plugin_name			= 'divi-content-toggle';
			$this->plugin_version		= ELICUS_DIVI_CONTENT_TOGGLE_VERSION;
			$this->plugin_basename		= ELICUS_DIVI_CONTENT_TOGGLE_BASENAME;
	        $this->metadata_url 		= 'http://cdn.elicus.com';
	        $this->upgrade_transient    = 'upgrade_divi_content_toggle';
	        $this->last_checked_option  = 'divi_content_toggle_last_checked';
	...
	new El_DiviContentToggle_Update;
}
